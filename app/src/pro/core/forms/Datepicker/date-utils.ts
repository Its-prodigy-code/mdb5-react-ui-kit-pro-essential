...
export function isNextDateDisabled(
  ...
  return maxDate && areDatesInSameView(date, maxDate, view, yearsInView, minDate, maxDate);
}
...
export function isPreviousDateDisabled(
  ...
  return minDate && areDatesInSameView(date, minDate, view, yearsInView, minDate, maxDate);
}
