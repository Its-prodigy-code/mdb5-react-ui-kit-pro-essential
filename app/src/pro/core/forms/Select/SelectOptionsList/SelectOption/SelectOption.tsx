...
const MDBSelectOption: React.FC<SelectOptionProps> = ({
  ...
  const onChangeCheckbox = useCallback(
    ...
    [checkedState, onChange, disabled, multiple]
  );
      ...
      {revert ? (
        <>
          ...
          <div className='select-option-text'>
            {multiple && (
              <MDBCheckbox label={text} onChange={onChangeCheckbox} checked={checkedState} dsabled={disabled} i />
            )}
            {!multiple && text}
        ...
        <>
          <div className='select-option-text'>
            {multiple && (
              <MDBCheckbox label={text} onChange={onChangeCheckbox} checked={checkedState} disabled={disabled} />
            )}
            {!multiple && text}
            {secondaryText && <span className='select-option-secondary-text'>{secondaryText}</span>}
          </div>
