    ...
    if (stacking) {
      if (isShown) {
        ...
        if (selectedToasts.length > 0) {
          ...
          if (posY === 'top') {
            offsetValue = (selectedToasts[selectedToasts.length - 1] as HTMLElement).style.top;
          } else {
            offsetValue = (selectedToasts[selectedToasts.length - 1] as HTMLElement).style.bottom;
          }
